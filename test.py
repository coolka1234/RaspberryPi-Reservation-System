...
def test_delete_room():
    ...
    assert response_delete.status_code == 200  # Ensure the room was deleted successfully
...
def test_create_reservation():
    ...
    assert response.status_code == 201  # Ensure the reservation was created successfully
...
def test_get_reservations():
    ...
    print(response.data)  # Print the response body to debug
    assert response.status_code == 200  # Ensure the reservations are retrieved successfully
...
def test_update_reservation():
    ...
    print(response.data)  # Print the response body to debug
    assert response.status_code == 200  # Ensure the reservation was updated successfully
...
def test_delete_reservation():
    ...
    assert response_delete.status_code == 200  # Ensure the reservation was deleted successfully
